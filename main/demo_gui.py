...
class table(QtGui.QWidget):
    ...
    def create(self):
        ...
        self.ui.textEdit.setText(str(filename2))
        rgb_img = cv2.imread(filename2)
        ...
        for (x,y,w,h) in faces:
            ...
            print t
            if t==1:
                alert(text='angry', title='Emotion detection', button='OK')
            if t==2:
                alert(text='dipression', title='Emotion detection', button='OK')
            if t==3:
                alert(text='fear', title='Emotion detection', button='OK')
            if t==4:
                alert(text='happy', title='Emotion detection', button='OK')
            if t==5:
                alert(text='No expression', title='Emotion detection', button='OK')
            if t==6:
                alert(text='surpice', title='Emotion detection', button='OK')
            if t==7:
                alert(text='sad', title='Emotion detection', button='OK')
